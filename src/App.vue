        ...
        <b-collapse id="nav-collapse" is-nav>
          ...
          <b-navbar-nav class="ml-auto">
            <b-nav-item-dropdown right>
              ...
              <b-dropdown-item href="https://twitter.com/joseluisgonsan" target="_blank">Contacto</b-dropdown-item>
            </b-nav-item-dropdown>
          </b-navbar-nav>
        </b-collapse>
      </b-navbar>
...
<footer class="footer">
    <div class="container text-center">
            <span class="text-muted"><a style="color:#9d9d9d" href="https://twitter.com/joseluisgonsan"
                target="_blank">José
                Luis González Sánchez.</a></span>
